                        ...
                        <input type="hidden" name="txtcounttotal" id="txtcounttotal" value="<?php echo $totalcount; ?>">
                          ...
                          if(!empty($clients)){
                            ...
                            foreach ($clients as $user) {
                              $redirectUrl = base_url('admin/model-details/').$user->unique_code;
                          ?>

                            <tr >
                                <th><?php echo ++$count; ?></th>
                                <td> 
                                  <strong><?php echo $user->model_name; ?></strong>
                                  <div style="color:#259cf1;" >#<small><b><?php echo $user->unique_code ?></b></small></div>
                                </td>
                                  
                                <td> 
                                  <strong><?php echo $user->name; ?></strong>
                                  <div style="color:#259cf1;" ><small><b><?php echo $user->surname ?></b></small></div>
                                </td>

                                <td> <?php echo $user->email  ?> </td> 
                                <td> 
                                  <strong><?php echo $user->address_line1; ?></strong>
                                  <div><small><strong><?php echo $user->city; ?></strong></small></div>
                                  <div style="color:#259cf1;" ><small><b>Zipcode : <?php echo $user->pincode ?></b></small></div>
                                </td>
