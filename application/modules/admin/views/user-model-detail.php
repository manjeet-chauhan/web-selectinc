      ...
      <div class="row">
        <div class="col-md-12">
          <h1 class="text-uppercase"> 
              <i class="fa fa-user"></i> User Model Detail
          </h1>
        </div>
              ...
              <div class="col-md-12">
                  <div class="table-responsive">
                    <table id="userprofile" class="table table-striped">
                        ...
                        <tr>                          
                          <th>User Name</th>
                          <td><?php echo $model->u_name.'(<small><b>'.$model->user_code.'</b></small>)';  ?> </td>
                        </tr>
                        <tr>                          
                          <th>User Email</th>
                          <td  ><?php echo $model->u_email;  ?> </td>
                        </tr>                        
                         <tr>
                          <th colspan="3" style="background-color: #000; color: #fff;">Model Detail</th>
                        </tr> 
                        <tr>                          
                          <th>Model Code</th>
                          <td  >#<?php echo $model->unique_code;  ?> </td>
                        </tr> 
                        <tr>                          
                          <th>Model Name</th>
                        ...
                        <tr>                          
                          ...
                          <td  ><?php echo $model->address_line2;  ?> </td>
                        </tr>

                        <tr>                          
                          <th>Zipcode</th>
                          <td  ><?php echo $model->pincode;  ?> </td>
                        </tr>
                        ...
                        <tr>                          
                          ...
                          <td  ><?php echo $model->vat_tin_number;  ?> </td>
                        </tr>
                        <tr>                          
                          <th>Email</th>
                        ...
                        <tr>                          
                          ...
                          <td><?php echo $model->kvat ? 'Yes ('.$model->kvat_percent.'%)' : 'No';  ?> </td>
                        </tr>
