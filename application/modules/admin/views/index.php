                        ...
                        <input type="hidden" name="txtcounttotal" id="txtcounttotal" value="<?php echo $totalcount; ?>">
                          ...
                          if(!empty($users)){
                            ...
                            foreach ($users as $user) {
                              ...
                              $redirectUrl = base_url('admin/user-profile/').$user->username."/".$user->unique_code;
                              $redirectClientUrl = base_url('admin/clients/').$user->username."/".$user->unique_code;
                              $redirectModelUrl = base_url('admin/models/').$user->username."/".$user->unique_code;
                              $redirectInvoiceUrl = base_url('admin/invoices/').$user->username."/".$user->unique_code;
                              $redirectRefundUrl = base_url('admin/refund/').$user->username."/".$user->unique_code;
                          ...
                          ?>
                            ...
                            <tr class="<?php echo $scls; ?>">
                                ...
                                <td>
                                  <a href="<?php echo $redirectClientUrl; ?>" class="btn btn-warning btn-sm btn-block"><i class="fa fa-info"></i> CLIENTS</a>
                                </td>
                                <td>
                                  <a href="<?php echo $redirectModelUrl; ?>" class="btn btn-primary btn-sm btn-block"><i class="fa fa-eye"></i> MODELS</a>
                                </td>
                                <td>
                                  <a href="<?php echo $redirectInvoiceUrl; ?>" class="btn btn-success btn-sm btn-block"><i class="fa fa-eye"></i> INVOICES </a>
                                  <div style="margin-top: 5px;"> <a href="<?php echo $redirectRefundUrl; ?>" class="btn btn-black btn-sm btn-block"><i class="fa fa-eye"></i> REFUND </a>
                                  </div>
                                </td>
                                

                                 <td><button data-id="<?php echo $user->id; ?>" data-status="<?php echo $user->status; ?>" data-toggle="modal"  data-target="#modalAccountStatus" class="accountstatbtn <?php echo $sbcls; ?>"><?php echo $status  ?></button> </td>
                                <td>
                                  <a href="<?php echo $redirectUrl; ?>" class="btn btn-warning btn-sm btn-block"><i class="fa fa-eye"></i> PROFILE</a>
                                  
                                  <!-- <a href="<?php echo $redirect_edit; ?>" class="btn btn-success"><i class="fa fa-pencil-square-o"></i></a> -->

                                  <button data-id="<?php echo $user->id; ?>" data-toggle="modal"  data-target="#modalDeleteAccount" class="btn btn-danger btn-sm btn-block" onclick="$('#deleteusrid').val($(this).attr('data-id'))"><i class="fa fa-trash"></i> DELETE</button>
                                </td>
