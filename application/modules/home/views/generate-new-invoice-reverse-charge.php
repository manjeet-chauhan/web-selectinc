				...
				<div class="DashboardContent">
					...
					<div class="OpenTicket Box">
						...
						<div class="BoxHeading generate">
							...
							<h4>Generate Reverse Invoice</h4>
									...
									<tbody>
										...
										<tr>
											...
											<td colspan="6"> 
												...
												$prev_url = base_url('generate-reverse-charge-invoice/?page=').$page_prev.'&offset='.$offset.'&limit='.$records_on_page.'&status_id='.$search_status.'&assigned_to_id='.$search_assignee.'&priority_id='.$search_priority;

												$next_url = base_url('generate-reverse-charge-invoice/?page=').$page_next.'&offset='.$offset.'&limit='.$records_on_page.'&status_id='.$search_status.'&assigned_to_id='.$search_assignee.'&priority_id='.$search_priority; 
												?>
				...
				<div class="row">
					...
					<div class="col-md-3">
						...
						<div class="Modelfee">
							...
							<h6><label><input type="radio" checked   name="apply_model_fee" id="apply_model_fee_1" value="1"> <input type="text" name="modelnametext1" id="modelnametext1" value="Total included"> </label></h6>
			...
			<div class="NewInvoice">
				...
				<!-- <div class="BorderRow"> -->
					...
					<div class="row">
						...
						<div class="col-md-3">							 
							<h6 class="pl-10"><label><input type="radio" name="apply_model_fee" id="apply_model_fee_2" value="2"> <input type="text" name="modelnametext2" id="modelnametext2" value="Amount Agreed Upon">  </label></h6>
						</div>

						<div class="col-md-2">							 
							 <input type="text" name="additional_modal_text" id="additional_modal_text" value="" placeholder="some text"> 
							 <input type="hidden" name="reverse_invoice" id="reverse_invoice" value="1"> 
						</div>
						<div class="col-md-2">							 
						...
						<div class="col-md-5">							 
							<h6 class="pl-10"><input style="width:100%; padding: 4px;" type="text" name="modelothertext" id="modelothertext" value="No Vat Reverse Charge"></h6>
						</div>
					</div>
				...
				<div class="NewInvoice">
					...
					<div class="BorderRow">
						...
						<div class="row">
							...
							<div class="col-md-5">
								<div><input style="width:100%; padding: 4px; margin-top: 5px;" type="text" name="acommissionothertext" id="acommissionothertext" value="No Vat Reverse Charge">
									</div> 
							</div>
					...
					<div id="moreReverseRow"></div>
					<input type="hidden" name="reverserowcount" id="reverserowcount" value="0">

					<div style="margin: 10px 0;"><button type="button" class="btn btn-warning btn-sm" onclick="reverseMoreData();">ADD MORE</button></div> 
						...
						<div class="row">
							...
							<div class="col-md-3">
								...
								<div class="Modelfee">
									...
									<input type="text" name="modelInclComission" id="modelInclComission" value="0" style="width: 75px;"> <b>%</b>
...
<div id="mwmReverseData" style="display: none;">	
	<div id="singlReverseSeparater@_rowReverse@"> 
		<div class="row">
			<div class="col-md-3">
				<div class="modeladdmoredata">
				<button type="button" class="btn btn-sm btn-danger" onclick="delReverseRow('singlReverseSeparater@_rowReverse@', @_rowReverse@)"><i class="fa fa-trash"></i></button>
				<input type="hidden" name="reverseTextdel@_rowReverse@" id="reverseTextdel@_rowReverse@" value="0">
				<input type="text" name="reverseinvoice@_rowReverse@" placeholder="Name">
				</div>
			</div>

			<div class="col-md-2">
				<div class="modeladdmoredata">
				<input type="text" name="modelText1Name@_rowReverse@" placeholder="Text 1">
				</div>
			</div>
			<div class="col-md-2">
				<div class="modeladdmoredata">
				<input type="number" min="0" name="reverseAmount@_rowReverse@" placeholder="Reverse Amount">
				</div>
			</div>
...
<script type="text/javascript">
	...
	function reverseMoreData(){
		var singleRow = $('#mwmReverseData').html();
		
		var rcount = $('#reverserowcount').val();
		if(rcount != ''){
			rcount = parseInt(rcount);
			rcount = rcount + 1;
		}

		singleRow = singleRow.replaceAll('@_rowReverse@', rcount);
		$('#reverserowcount').val(rcount);

		$('#moreReverseRow').append(singleRow);
	}

	function delReverseRow(deldata, deldataid){

		$('#'+deldata).css('display', 'none');
		$('#reverseTextdel'+ deldataid).val(1);
...
function getClientList(){
	...
	function manage_modal_val(){
		...
		if(selected_modal == 1){
			$('#additional_modal_price, #model_total_agreed').val(t_m_budget_0 - t_md_comiss_amt);
		}
	...
	$(function(){
		$('.token-data input[type="checkbox"]').click(function(){
			...
			var url = "<?php echo base_url('generate-reverse-charge-invoice/?page='); ?>";
