				...
				<div class="DashboardContent">
					<div class="OpenTicket Box">
						<div class="BoxHeading">
							...
							<!-- <div><a href="<?php echo base_url('client-list-invoice-without-vat') ?>">change without vat</a></div> -->
						</div>
					</div> 
						...
						<div class="filter-data">
							<form id="formfilter">
								<div class="row">
									...
									<div class="col-md-2">
										<label><input type="radio" checked name="invoice_type" > With Vat</label>
									</div>
									<div class="col-md-3">
										<label><input type="radio"  name="invoice_type" onchange="window.location.href='<?php echo base_url('client-list-invoice-without-vat') ?>'"> Without Vat</label>
									</div>
								...
								<form id="downloadForm" method="POST" action="<?php echo base_url('download-client-list-pdf'); ?>">
