				...
				<div class="DashboardContent">
					<div class="OpenTicket Box">
						<div class="BoxHeading">
							...
							<a class="pull-right btn btn-primary mbtn"  href="<?php echo base_url('edit-invoice-correction') ?>"> Invoice Correction </a>				 
							...
							<table class="table table-striped">
								...
								<tbody>
									...
									foreach ($invoices as $invoice) {
										...
										$correction_url = base_url('edit-invoice-correction?invoive=').$invoice->invoice_number; 
									...
									<tr>
										...
										<td>1400.00</td>
										<td>
											 <a href="<?php echo $correction_url; ?>" class="btn btn-sm btn-primary btn-block" >Correction</a> 
