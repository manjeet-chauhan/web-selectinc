				...
				<div class="DashboardContent">
							...
							<table class="table table-striped">
								...
								<thead>
									...
									<tr>
										...
										<th style="width: 10%;">Edit Model</th> -->
								...
								<tbody>
									...
									<tr onclick="window.location.href='<?php echo $redirect_edit; ?>'">
										...
										<td><?php echo $model->kvat_percent; ?>%</td>
					...
					<div class="OpenTicket Box">
						...
						<!-- <div class="ClientManagement">
							...
							<button type="button" class="btn bg-white btn-outline-primary"><img src="<?php echo base_url('assets/frontend/images/import.svg'); ?>" alt="Icon"> Import Model</button>
