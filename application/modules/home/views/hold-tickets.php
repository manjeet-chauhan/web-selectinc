							...
							<div class="row">
								...
								<div class="col-md-6">
									...
									<select id="status_id" name="status_id" class="form-control myselect">
										...
										<?php 
										$s_status = get_issue_hold_status();
										if(!empty($s_status)){
							...
							<table class="table table-striped">
								...
								<tbody>
									...
									<tr>
										...
										$prev_url = base_url('hold-tickets/?page=').$page_prev."&status_id=".$search_status;
										$next_url = base_url('hold-tickets/?page=').$page_next."&status_id=".$search_status;
										?>
