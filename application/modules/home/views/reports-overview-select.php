							...
							<div class="table-responsive">
								...
								?>
									...
									foreach ($invoices as $invoice) {
										$total = $invoice->model_ser_amount;
										$inv_total += $total;
									?>

									<tr >
										<td><?php echo ++$count; ?></td>
										<td><?php echo $invoice->model_service ?></td>
										<td><?php echo $invoice->model_ser_amount ?>€</td>
										<td>
											<?php 
											if($invoice->vat_include == 1){
												$vat = (($invoice->model_ser_amount*$invoice->vat_percent)/100);
