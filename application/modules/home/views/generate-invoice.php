						...
						<div class="ModelMgmt">
										...
										<div class="invoice-cont rowCount<?php echo ($i+1) ?>">
											...
											<div class="row">
												...
												<div class="col-md-9">
													...
													<div class="InvoiceData"> 
														<p><input type="text" <?php echo $disabled; ?> class="invoivevalue" name="invoivevalue<?php echo ($i+1) ?>" id="invoivevalue<?php echo ($i+1) ?>" value="<?php echo $headers[$i]->invoive_value ?>" onblur="manageinvoicedata(this)">
							...
							<?php }} ?>
								...
								<div class="Table Invoice">
									...
									<table class="table table-striped Invoice table-condensed" >
										...
										<tbody>
											...
											<tr>
												<th><?php echo $invoice->modelnametext1 ?></th>
												<th> </th>
												<th> </th>												
											...
											<tr>
												<th>
													<?php echo $invoice->modelnametext2 ?>
											...
											<tr>
												...
												<th>
													Agency commission
													<?php if(!empty($invoice->acommissionothertext)){ ?>
											...
											$total_modal_agreed_exp = $total_modal_agreed_exp + $reverse_amount;
								...
								<?php
									...
									?>
									<div class="row">
										<?php if(!empty($invoice->approve_message)){ ?>
										<div class="col-md-12">
											<div><label><b>Request change Message :</b></label></div>
											<?php echo $invoice->approve_message ?>
											<br>												
										</div>
										<?php } ?>
										<div class="col-md-3">&#160;</div>
										<div class="col-md-4">
											<a href="<?php echo $edit_url ?>"><button type="button " class="btn cancel btn-warning" style="margin-top: 54px; width: 100%;"> <i class="fa fa-arrow-left" aria-hidden="true"></i> Edit / Back </button></a> 
										</div>
								...
								<div class="row">
									<div class="col-md-4">&#160;</div>
									<div class="col-md-4">
										<button data-toggle="modal" data-target="#approveInvoice" data-invoice="<?php echo $invoice_no; ?>"  type="button " class="btn cancel btn-warning" style="margin-top: 54px; width: 100%;" onclick="$('#approve_invoice_id').val($(this).attr('data-invoice'))"> <i class="fa fa-arrow-left" aria-hidden="true"></i> Approve </button>  
									</div>
								</div>
