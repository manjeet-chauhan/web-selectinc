				...
				<div class="DashboardContent">
					...
					<div class="OpenTicket Box">
						...
						<div class="BoxHeading generate">
							...
							<h4>Edit Reverse Charges Invoice</h4>
									...
									<div class="row">
										...
										<div class="col-md-6">
											...
											<div class="custom-control custom-radio">
												...
												<input type="hidden" name="m_vat_yes_checked" id="m_vat_yes_checked" value="0">
			...
			<div class="NewInvoice">
				...
				<!-- <div class="BorderRow"> -->
					...
					<div class="row">
						...
						<div class="col-md-5">							 
							<h6 class="pl-10"><input style="width:100%; padding: 4px;" type="text" name="modelothertext" id="modelothertext" value="<?php echo $invoice_info->modelothertext ?>"></h6>
						</div>
					</div>
								    ...
								    <div class="BorderRow">
								        ...
								        <div class="row">
								            ...
								            <div class="col-md-3">
								             ...
								             <div class="col-md-6">
								             	<div><input style="width:100%; padding: 4px; margin-top: 5px;" type="text" name="acommissionothertext" id="acommissionothertext" value="<?php echo $invoice_info->acommissionothertext ?>">
