...
<style type="text/css">
	...
	#model_budget, #model_total_agreed, .Modelfee input[type="number"], #modelDeductionValue{
	...
	<div class="container">
		...
		<div class="row">
				...
				<div class="DashboardContent">
					...
					<div class="OpenTicket Box">
						...
						<div class="BoxHeading generate">
							...
							<h4> Edit Refund <?php if(!empty($invoice_number)) echo ' [' . $invoice_number . ']' ?></h4>
			...
			<form id="formInvoice" name="formInvoice">
				...
				<div class="OpenTicket Box Boxtwo NoRadius ModelMgmt" style="display: none;" >
		...
		<div class="OpenTicket Box Boxtwo NoRadiusForm" style="display: none;" >
							...
							<div class="row">
								...
								<div class="col-md-7">
									...
									<div class="form-group">
										...
										<input type="date" class="form-control" placeholder="Job Date" id="job_date" name="job_date" value="<?php echo $invoice_info->job_date; ?>">

										<?php 
											$Date1 = $invoice_info->job_date;
											$date = new DateTime($Date1);
											$date->modify('+'.(int)$invoice_info->payment_terms.' day');
											$job_date_till = $date->format('Y-m-d');
										?>

										<input type="date" class="form-control" placeholder="Job Date Till" id="job_date" name="job_date_till" value="<?php echo $job_date_till; ?>">
							...
							<div class="row">
								...
								<div class="col-md-7">
									...
									<div class="form-group">
										...
										<input type="date" class="form-control" id="invoice_date" name="invoice_date" value="<?php echo $invoice_info->invoice_date; ?>">
								...
								<div class="col-md-7"> 
									<div class="form-group"> 
										<textarea type="text" class="form-control" placeholder="1234567" rows="4" id="uses" name="uses"><?php echo $invoice_info->uses; ?></textarea> 
									</div> 
								</div> 
							...
							<div class="row">
								...
								<div class="col-md-7">
									...
									<div class="form-group">
										...
										<input type="date" class="form-control" id="invoive_due_date" name="invoive_due_date" value="<?php echo $invoice_info->invoive_due_date; ?>">
										...
										<div class="row">
											...
											<div class="col-md-7">
												...
												<div class="form-group">
													...
													<input type="text" class="form-control" placeholder="Name" id="m_service_fee" name="m_service_fee" value="<?php echo $invoice_info->m_service_fee; ?>">
		...
		<div class="OpenTicket Box Boxtwo NoRadiusForm">
			...
			<div class="BorderRow">
				...
				<div class="row">
					...
					<div class="col-md-3">
						 <div class="Modelfee">
		                    <h6><label><input <?php if($invoice_info->apply_model_fee == 1){ echo 'checked'; } ?> type="radio" checked name="apply_model_fee" id="apply_model_fee_1" value="1" > Model Fee Net </label></h6>
		                </div>
					...
					<div class="col-md-3">
						...
						<div class="Modelfee text-right">
		                    <h6><i class="fa fa-eur" aria-hidden="true"></i>  <input type="number" name="model_budget" id="model_budget" readonly min="0" value="<?php if(!empty($invoice_info)){  echo $invoice_info->model_budget; }?>"></h6>
		                </div>
			...
			<div class="NewInvoice">
				...
				<!-- <div class="BorderRow"> -->
					...
					<div class="row">
						...
						<div class="col-md-3">							 
							 <h6 class="pl-10"><label><input <?php if($invoice_info->apply_model_fee == 2){ echo 'checked'; } ?> type="radio" name="apply_model_fee" id="apply_model_fee_2" value="2"> Model Total Agreed </label></h6>
						</div>

						<div class="col-md-2">							 
							 <input type="text" name="additional_modal_text" id="additional_modal_text" value="<?php echo $invoice_info->additional_modal_text ?>" readonly> 
						</div>
						<div class="col-md-2">							 
							 
						</div>
						<div class="col-md-2">							 
							<input type="text" name="additional_modal_price" id="additional_modal_price" step="any" min="0"  value="<?php echo $invoice_info->additional_modal_price; ?>" readonly> 
						</div>

						<div class="col-md-3">
							<div class="Modelfee text-right">
								<h6 class="pr-10"><i class="fa fa-eur" aria-hidden="true"></i>  <input type="number" name="model_total_agreed" id="model_total_agreed" min="1" step="any" value="<?php echo $invoice_info->model_total_agreed ?>" readonly ></h6>
							</div>
						</div>
					</div>
			        ...
			        <div id="divDispModelDeduction"> 
						<div class="row">
							<div class="col-md-3">
								<div class="modeladdmoredata">
									<button disabled type="button" class="btn btn-sm btn-danger"><i class="fa fa-trash"></i></button>	
									<input type="text"   name="deduction" placeholder="Deduction" value="Deduction">
								</div>
							</div>
							...
							<div class="col-md-2">
								<div class="modeladdmoredata">
									...
									if(!empty($invoice_info->model_id)){
										$mdl_data = get_model_info($invoice_info->model_id);
									?>
									<a target="_blank" href="<?php echo base_url('create-deduction-transaction/').$mdl_data->unique_code; ?>">View Deduction</a>

									<input type="hidden" readonly name="modeldeduction"  value="<?php echo $mdl_data->unique_code; ?>">
									<?php
									}
							...
							<div class="col-md-2">
								...
								<?php
								$total_d = $invoice_info->model_total_agreed;
								if(!empty($deduction_info->wallet)){
								...
								if($invoice_info->refund == 1)
									if($invoice_info->deduction_amout > 0){
										$total_d =  $invoice_info->deduction_amout;
									}
								?>
								<input type="number" max="<?php echo $total_d ?>" min="0" placeholder="amount" min="0" name="modelDeductionValue"  id="modelDeductionValue"  value="<?php if(!empty($deduction_info)) { echo $deduction_info->wallet; }else{ echo 0; }?>">
								</div>
							</div>
					...
					<div style="display: none;"><button type="button" class="btn btn-warning btn-sm" onclick="moreModelData();">ADD MORE</button></div> 
					<br>
					<!-- </div> -->
								        ...
								        <div class="row">
								            ...
								            <div class="col-md-3">
								                ...
								                <div class="Modelfee Icon text-right">
								                    ...
								                    <h6 class="pr-10"><i class="fa fa-eur" aria-hidden="true"></i> <span id='modalsvatamt'><?php if(!empty($invoice_info)&&($invoice_info->m_vat==1)){echo ($invoice_info->m_vat_percent*$invoice_info->model_total_agreed)/100;}?></span></h6>
					        ...
					        <div class="row">
					            <div class="col-md-3">
					                ...
					                <button class="btn btn-danger btn-sm" type="button" onclick="deleteModelExpenses('demomdlexpRow<?php echo $expCount;  ?>', <?php echo $expCount;  ?>)"><i class="fa fa-trash"></i> </button>								                	
					                     <input type="text" placeholder="Expense Name" name="model_expense<?=$expCount?>" value="<?php echo $expense->model_expense?>" readonly>
					            ...
					            <div class="col-md-3">
					                <div class="custom-control custom-radio">
									    ...
									    <input class="chargespercent" type="number" class="" id="expences_vat_percent<?=$expCount?>" value="<?php echo $expense->vat_percent; ?>" name="expences_vat_percent<?=$expCount?>" readonly>
								    </div>
					            </div>

					            <div class="col-md-3">
					                <div class="Modelfee Icon text-right">
					                    <h6><i class="fa fa-eur" aria-hidden="true"></i> <input type="number" name="model_exp_amount<?=$expCount?>" min="1" step="any" value="<?php echo $expense->model_exp_amount;?>" readonly></h6>
					                </div>
					             </div>
					        </div>
					    </div>
								        ...
								        <div class="row">
								            ...
								            <div class="col-md-3">
								                ...
								                <div class="Modelfee">
								                    ...
								                    <input type="text" name="modelAgencyComission" id="modelAgencyComission" value="<?php if(!empty($invoice_info)) { echo $invoice_info->model_agency_comission; }?>" style="width: 75px;" readonly> <b>%</b>
								            ...
								            <div class="col-md-3">
								                ...
								                <div class="Modelfee Icon text-right">
								                    ...
								                    <h6><i class="fa fa-eur" aria-hidden="true"></i> <span id="spanmodal_service_fee"><?php
								                    $mwm = 0;
									        ...
									        <div class="row">
									            ...
									            <div class="col-md-3">
									                ...
									                <div class="Modelfee">
									                    ...
									                    <h6>VAT added <span id="spanvatinccom"></span></h6>
									                     ...
									                     <input type="text" readonly name="modelInclComission" id="modelInclComission" value="<?=$invoice_info->vat_price?>" style="width: 75px;"> <b>%</b>
									            ...
									            <div class="col-md-3">
									                ...
									                <div class="Modelfee Icon text-right">
									                    ...
									                    <h6><i class="fa fa-eur" aria-hidden="true"></i> <span id="spnfinalcompvatamt"><?php
			...
			<div class="OpenTicket Box Boxtwo NoRadiusForm" >
				...
				<div class="NewInvoice">
					...
					<div id="modelservice">
				    	...
				    	?>
				    	<div class="BorderRow <?php echo $disabledc; ?>" id="demomdlSerRow<?php echo $serCount; ?>">
						        ...
						        <div class="row">
						            ...
						            <div class="col-md-3">
						                ...
						                <div class="Modelfee">
						                	...
						                	<button class="btn btn-danger btn-sm" type="button" onclick="deleteModelService('demomdlSerRow<?php echo $serCount; ?>', <?php echo $serCount; ?>)"><i class="fa fa-trash"></i> </button>
						                     ...
						                     <input <?php echo $disabled; ?> type="text" placeholder="Service Name" name="model_service<?=$serCount?>" value="<?php echo $service->model_service;?>" readonly>
						                     <input <?php echo $disabled; ?> type="hidden" placeholder="Service ID" name="model_service_id<?=$serCount?>" id="model_service_id<?=$serCount?>" value="<?php echo $service->id;?>" readonly>
						                     <input <?php echo $disabled; ?> type="hidden" name="model_ser_del<?=$serCount?>" id="model_ser_del<?=$serCount?>" readonly>
						            ...
						            <div class="col-md-3">
						                ...
						                <div class="custom-control custom-radio">
										    ...
										    <input type="radio" <?php echo $disabled; ?> class="custom-control-input" id="svati<?=$serCount?>" value="0" name="service_vat_include<?=$serCount?>" <?php if($service->vat_include==0){echo "checked";}?> >
						            ...
						            <div class="col-md-3">
						                ...
						                <div class="custom-control custom-radio">
										    <input <?php echo $disabled; ?> type="radio" class="custom-control-input" id="svate<?=$serCount?>" value="1" name="service_vat_include<?=$serCount?>" <?php if($service->vat_include==1){echo "checked";}?>>
										    <label class="custom-control-label" for="svate<?=$serCount?>">VAT excluded</label>
										    <input class="chargespercent" type="number" class="" id="special_need_vat_percent<?=$serCount?>" value="<?php echo $service->vat_percent; ?>" name="special_need_percent<?=$serCount?>"  step="any" readonly>
									    </div>
						            </div>

						            <div class="col-md-3">
						                <div class="Modelfee Icon text-right">
						                    <h6><i class="fa fa-eur" aria-hidden="true"></i> <input type="number" name="model_service_amount<?=$serCount?>" min="1" step="any" value="<?php echo $service->model_ser_amount;?>" readonly></h6>
						                </div>
						             </div>
						        </div>
            ...
            $.ajax({
            	...
            	success: function (data) { 
            		...
            		if(data == "success"){
            			...
            			window.location.href = "<?php echo base_url('invoive-refund?invoive='); ?>" + $('#invoice_number').val();
            			// location.reload();
            			return true;
            		} 
