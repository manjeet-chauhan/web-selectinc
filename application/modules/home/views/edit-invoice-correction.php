...
<section class="Dashboard">
	...
	<div class="container">
							...
							<div class="row">
								...
								<div class="col-md-7">
									...
									<div class="form-group">
										...
										<input type="date" class="form-control" placeholder="Enter Company Name" id="job_date" name="job_date" value="<?php echo $invoice_info->job_date; ?>">
							...
							<div class="row">
								...
								<div class="col-md-7">
									...
									<div class="form-group">
										...
										<input type="date" class="form-control" placeholder="Enter Company Name" id="job_date" name="job_date_till" value="<?php echo $job_date_till; ?>">
							...
							<div class="row">
								...
								<div class="col-md-7">
									...
									<div class="form-group">
										...
										<input type="date" class="form-control" id="invoice_date" name="invoice_date" value="<?php echo $invoice_info->invoice_date; ?>" onchange="addDays();">
		...
		<div class="OpenTicket Box Boxtwo NoRadiusForm">
				...
				<div class="row">
					...
					<div class="col-md-3">
						...
						<div class="Modelfee text-right">
		                    <h6><i class="fa fa-eur" aria-hidden="true"></i>  <input type="number" name="model_budget" id="model_budget" min="0" value="<?php if(!empty($invoice_info)){  echo $invoice_info->model_budget; }?>"></h6>
		                </div>
					...
					<div id="modelexpence">
				    	...
				    	<div class="BorderRow ExpRow_<?=$expCount?>" id="demomdlexpRow<?php echo $expCount;  ?>">
					        <div class="row">
					            ...
					            <div class="col-md-3">
					                <div class="Modelfee Icon text-right">
					                    <h6><i class="fa fa-eur" aria-hidden="true"></i> <input type="number" name="model_exp_amount<?=$expCount?>" min="1" step="any" value="<?php echo $expense->model_exp_amount;?>"></h6>
					                </div>
					             </div>
					        </div>
					    </div>
					...
					<div id="modelservice">
				    	...
				    	<div class="BorderRow" id="demomdlSerRow<?php echo $serCount; ?>">
						        ...
						        <div class="row">
						            ...
						            <div class="col-md-3">
						                <div class="Modelfee Icon text-right">
						                    <h6><i class="fa fa-eur" aria-hidden="true"></i> <input type="number" name="model_service_amount<?=$serCount?>" min="1" step="any" value="<?php echo $service->model_ser_amount;?>"></h6>
						                </div>
						             </div>
						        </div>
			...
			<div class="OpenTicket Box Boxtwo NoRadius"> 
				<div class="form-group">
				    <label for="email">Correction Inputs:</label>
				    <textarea class="form-control" placeholder="Description for make changes for correction" id="correction_input" name="correction_input"><?php echo $invoice_info->correction_input ?></textarea>
				</div>
			</div>
			<div class="OpenTicket Box Boxtwo NoRadius"> 
				<div class="Divpdf">  
	...
	<div class="alert alert-danger"> <b>No Invoice Selected for correction</b></div>
	...
	$(function(){
		...
		$('#formInvoice').submit(function(e){ 
            ...
            $.ajax({
            	...
            	url: '<?php echo base_url('save-edit-invoice-correction'); ?>',
            	type: "POST",
            	...
            	success: function (data) { 
            		...
            		if(data == "success"){
            			...
            			window.location.href = "<?php echo base_url('invoice-correction'); ?>";
            			// location.reload();
            			return true;
            		} 
